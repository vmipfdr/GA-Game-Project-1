...
//add this event listener into the function that compares answers
...
function populateQuestion(e) {
	...
	// answerText.innerText = triviaQuestions[qCtr].amplifyingInfo;
	qCtr+=1; 
}
...
function selectAnswer(e) {
	...
	// if (e.target.innerText == triviaQuestions[qCtr].answer) {
	// 	e.preventDefault();
	// 	console.log(triviaQuestions[qCtr].answer);
	// }
	// if (e.target.innerText == triviaQuestions[qCtr].answer) {
