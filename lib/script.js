...
function resetGame() {
	...
	document.querySelector('.loosing').style.display = 'none';
	document.querySelector('.loosingText').style.display = 'none';
	document.querySelector('.winning').style.display = 'none';
	document.querySelector('.winningText').style.display = 'none';
}
